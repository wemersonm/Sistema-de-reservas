            ...
            <div class="infoReservation">
                <form action="/car/reserve" method="POST" class="form-control d-flex flex-column align-items-center text-center">
                    <div class="pickupReservation">
                        ...
                        <input class="form-control" type="date" name="pickupDate" id="pickupDate" value="<?php echo date("Y-m-d", time());?>">
                    ...
                    <div class="returnReservation">
                        ...
                        <input class="form-control " type="date" name="returnDate" id="returnDate" value="<?php echo date("Y-m-d", time());?>">
